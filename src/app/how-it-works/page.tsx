...
function EncryptionDemo() {
  ...
  // Re-derive on every keystroke. Cheap.
  ...
  // Re-roll on first mount so SSR/client agree on something deterministic
  // (the keys are deliberately fresh every visit — nothing here persists).
  useEffect(() => {
    reroll();
  }, []);
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        <Section icon={Lock} title="Need a second layer? Wash it.">
          <p>
            ...
            <Link href="/wash" className="text-zinc-100 underline hover:text-white">
              Wash
            </Link>{' '}
