    ...
    <div className="min-h-screen bg-black flex flex-col relative overflow-hidden">
      ...
      <header className="relative z-10 w-full px-6 py-4 flex items-center justify-between border-b border-white/5 bg-black/60 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/login" className="px-5 py-2 rounded-lg font-medium text-sm text-white bg-gradient-to-r from-zinc-700 to-zinc-500 hover:from-zinc-600 hover:to-zinc-400 border border-white/15 transition-all">
            Enter Void
          </Link>
        </div>
      </header>
        ...
        <div className="w-full max-w-7xl mx-auto flex items-start justify-between gap-8 mt-8">
          ...
          <div className="flex-1 flex flex-col items-center text-center max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <Link href="/login" className="px-10 py-4 rounded-xl text-lg font-semibold text-white bg-gradient-to-r from-zinc-700 via-zinc-500 to-zinc-400 hover:from-zinc-600 hover:via-zinc-400 hover:to-zinc-300 border border-white/20 shadow-[0_0_40px_rgba(255,255,255,0.15)] transition-all hover:scale-105">
                Enter Void
              </Link>
