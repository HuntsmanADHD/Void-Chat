          ...
          <div className="text-center">
            <div className="w-20 h-20 rounded-full bg-zinc-700 mx-auto mb-4 flex items-center justify-center">
              <span className="text-3xl font-bold text-white">
                {(incomingCall.callerXHandle || incomingCall.callerId.slice(0, 2)).charAt(0).toUpperCase()}
              </span>
            </div>
            ...
            <p className="text-zinc-400 mb-6">
              {incomingCall.callerXHandle ? `@${incomingCall.callerXHandle}` : `${incomingCall.callerId.slice(0, 8)}...`}
            </p>
