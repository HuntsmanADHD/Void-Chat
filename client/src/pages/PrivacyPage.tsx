  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8"><Link to="/" className="text-purple-400 hover:text-purple-300 transition-colors">&larr; Back to Void Chat</Link></div>
        ...
        <div className="prose prose-invert prose-purple max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mt-4">See our <Link to="#warrant-canary" className="text-purple-400 hover:text-purple-300">Warrant Canary</Link> for transparency about legal requests we have NOT received.</p>
          </section>
          <section>
