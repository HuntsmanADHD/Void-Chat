  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <Link to="/" className="text-purple-400 hover:text-purple-300 transition-colors">&larr; Back to Void Chat</Link>
        </div>
        ...
        <div className="prose prose-invert prose-purple max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">Welcome to Void Chat (&quot;Void Chat,&quot; &quot;we,&quot; &quot;our,&quot; or &quot;the Platform&quot;). Void Chat is a privacy-first, peer-to-peer messaging platform with zero-knowledge architecture. By accessing or using Void Chat, you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, do not use the Platform.</p>
            <p className="text-gray-300 leading-relaxed">Void Chat operates as a community-governed platform where users are responsible for maintaining community standards through a decentralized moderation system.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white border-b border-gray-700 pb-2">2. Eligibility</h2>
            <p className="text-gray-300 leading-relaxed">To use Void Chat, you must:</p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              <li>Be at least 18 years of age or the age of majority in your jurisdiction</li>
              <li>Have the legal capacity to enter into a binding agreement</li>
              <li>Be able to generate and securely store a cryptographic keypair</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white border-b border-gray-700 pb-2">3. Account & Keypair Authentication</h2>
            <p className="text-gray-300 leading-relaxed">Void Chat uses NaCl keypair-based authentication. Your public ID serves as your unique identifier on the Platform.</p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              <li><strong>No Account Recovery:</strong> We do not store passwords or recovery phrases. If you lose access to your private key, you lose access to your Void Chat identity.</li>
              <li><strong>Key Security:</strong> You are solely responsible for maintaining the security of your private keys.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">Void Chat operates on a decentralized, community-policed moderation model:</p>
            ...
            <p className="text-gray-300 leading-relaxed mt-4">Strikes are issued by community moderators and are recorded on your public ID. Permanent bans apply to the public ID and cannot be appealed through the Platform.</p>
            <h3 className="text-xl font-medium text-white mt-6 mb-3">6.3 No Central Authority</h3>
            <p className="text-gray-300 leading-relaxed">Void Chat does not maintain a support team, customer service, or centralized moderation authority. All content moderation is performed by community owners and their designated moderators. We do not intervene in community-level moderation decisions.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white border-b border-gray-700 pb-2">7. Encryption & Message Privacy</h2>
            <p className="text-gray-300 leading-relaxed">Void Chat implements end-to-end encryption for all messages:</p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              <li>Messages are encrypted using TweetNaCl cryptography</li>
              <li>Encryption keys are generated locally on your device</li>
            ...
            <p className="text-gray-300 leading-relaxed mt-4"><strong>Important:</strong> While we cannot access message content, metadata (such as sender/recipient public IDs, timestamps, and community membership) may be visible to the system for routing and moderation purposes.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white border-b border-gray-700 pb-2">8. Intellectual Property</h2>
            <p className="text-gray-300 leading-relaxed">You retain ownership of content you create and share on Void Chat. By using the Platform, you grant other users a limited license to view and interact with your content as intended by the Platform&apos;s features.</p>
            <p className="text-gray-300 leading-relaxed">The Void Chat name, logo, and Platform code are proprietary. You may not copy, modify, or distribute Platform assets without permission.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              ...
              <li>We are not liable for any losses related to lost encryption keys</li>
              <li>We are not responsible for actions of community moderators</li>
              <li>We do not guarantee the security of third-party services</li>
            </ul>
            <p className="text-gray-300 leading-relaxed mt-4">TO THE MAXIMUM EXTENT PERMITTED BY LAW, VOID CHAT SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING FROM YOUR USE OF THE PLATFORM.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white border-b border-gray-700 pb-2">10. Termination</h2>
            <p className="text-gray-300 leading-relaxed">You may stop using Void Chat at any time. We may terminate or suspend your access if:</p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">Void Chat is a community-governed platform. There is no central support team, email contact, or customer service department. All issues, reports, and moderation are handled through the community structure:</p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
            ...
            <p className="text-gray-300 leading-relaxed mt-4">By using Void Chat, you acknowledge and accept this community-based governance model.</p>
          </section>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 flex flex-wrap gap-4">
          ...
          <Link to="/" className="text-purple-400 hover:text-purple-300 transition-colors">Return to Void Chat</Link>
        </div>
      </div>
    </div>
  );
